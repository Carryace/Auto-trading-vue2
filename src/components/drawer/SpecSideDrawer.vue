<template>
  <section class="w-1/5 pr-3">
    <h1 class="text-xl font-bold">Watchers & Operators Explorer</h1>
    <p class="mt-3 mb-3">Please select watcher or operator to view the stock charting analysis</p>
    <div class="mt-3">
      <div class="font-bold text-base">
        <span class="cursor-pointer" @click="toggleWatcherFolder">
          <font-awesome-icon
            :icon="folderIcon"
      ...
      <ul
        ...
        <li
          ...
          &nbsp;--- 
          <span class="cursor-pointer hover:text-blue-600" @click="selectWatcher(watcher)" :class="watcherClass(watcher)">
